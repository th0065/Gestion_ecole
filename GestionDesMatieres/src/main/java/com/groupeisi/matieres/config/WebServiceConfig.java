package com.groupeisi.matieres.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema matiereSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://localhost:8082/api/matieres");
    ...
    public XsdSchema matiereSchema() {
        return new SimpleXsdSchema(
                new ClassPathResource("scr/main/xsd/matiere.xsd"));
    }
}
